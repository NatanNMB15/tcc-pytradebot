...
urlpatterns = [
    ...
    path('sistema/estrategiaadicionar/', views.estrategiaadicionar, name='estrategiaadicionar'),
    path('sistema/estrategiacriar/', views.estrategiacriar, name='estrategiacriar'),
    path('sistema/estrategialistar/', views.estrategialistar, name='estrategialistar'),
    path('sistema/estrategiateste/', views.estrategiateste, name='estrategiateste'),
